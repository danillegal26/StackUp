...
export function savePlayerSession(roomId: string, playerId: string, playerToken: string, name: string): void {
  const session: PlayerSession = { playerId, playerToken, name };
