...
export function detectLang(): Lang {
  ...
  return 'en'; // англійська за замовчуванням
}
...
const ru = {
  ...
  errNextStreet: 'Не удалось перейти на следующий стрит',
  ...
  awaitingWinner: (pot: string) => `Showdown — банк ${pot}, организатор выбирает победителя.`,
