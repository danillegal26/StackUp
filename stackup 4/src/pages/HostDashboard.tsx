        ...
        <>
          ...
          <div className="mb-4 grid grid-cols-2 gap-3">
            ...
            <Button variant="secondary" onClick={() => setTimerOpen(true)}>
              {room.turn_timer_seconds != null ? `Таймер: ${room.turn_timer_seconds}с` : 'Таймер: выкл'}
            </Button>
          </div>
      ...
      {timerOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm sm:items-center">
          <div className="w-full max-w-sm rounded-t-3xl bg-felt-light p-6 sm:rounded-3xl">
            <h2 className="mb-1 font-display text-lg font-semibold text-ivory">Таймер хода</h2>
            <p className="mb-5 text-sm text-muted">Сколько секунд у игрока на ход</p>
