    ...
    <div className="relative mx-auto aspect-[4/5] w-full max-w-sm select-none py-2">
      ...
      {sorted.map((p, i) => {
        ...
        return (
          ...
          >
            <div
              className={`flex flex-col items-center gap-1 rounded-xl border px-1.5 py-2 backdrop-blur-sm ${
                isMe ? 'border-brass bg-brass/10 ring-1 ring-brass' : 'border-hairline/10 bg-felt-light/80'
              }`}
            >
