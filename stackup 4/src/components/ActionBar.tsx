    ...
    <div className="space-y-3 rounded-2xl border border-hairline/10 bg-felt-light/80 p-4 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <button
          ...
          onClick={() => run('all_in')}
          className="inline-flex min-h-[40px] items-center justify-center gap-2 rounded-xl border-2 border-brass/60 bg-coal px-2 py-2 text-xs font-semibold text-paper transition active:scale-[0.98] disabled:opacity-40 disabled:border-hairline/15"
        >
          Олл-ин
        </button>
      </div>
